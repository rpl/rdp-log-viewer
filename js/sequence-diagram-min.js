...
(function() {
        ...
        var parser = {
            ...
            var lexer = {
                ...
                test_match: function(match, indexed_rule) {
                    ...
                    this.done && this._input && (this.done = !1), token) return this.options.backtrack_lexer && (backup = void 0), 
                    token;
                    if (this._backtrack) {
                        for (var k in backup) this[k] = backup[k];
                        return !1;
                    }
                    return this.options.backtrack_lexer && (backup = void 0), !1;
                },
                next: function() {
    ...
    _.extend(BaseTheme.prototype, {
        ...
        draw: function(container) {
            ...
            this._paper.setFinish(), $(document).trigger("diagram:rendered");
        },
        layout: function() {
    ...
    _.extend(FastTheme.prototype, BaseTheme.prototype, {
        ...
        draw_text: function(x, y, text, font) {
            var t, paper = this._paper, f = font || {};
            return f._obj ? t = paper.print_center(x, y, text, f._obj, f["font-size"]) : (t = paper.text(x, y, text), 
            t.attr(f)), t.toFront(), {
                text: t
            };
        },
        ...
        draw_signal: function(signal, offsetY) {
            var aX = getCenterX(signal.actorA), bX = getCenterX(signal.actorB), x = (bX - aX) / 2 + aX, y = offsetY + SIGNAL_MARGIN + 2 * SIGNAL_PADDING, tb = this.draw_text(x, y, signal.message, this._font), bb = tb.text.getBBox();
            tb.text.attr({
                x: bb.x - bb.width / 2
        ...
        draw_note: function(note, offsetY) {
            ...
            tb.text.attr({
                x: tb.text.getBBox().x - NOTE_PADDING
            });
        }
    });
    var themes = {
